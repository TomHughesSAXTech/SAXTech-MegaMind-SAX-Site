# n8n Search Nodes - Final Working Versions

## 1. QUICK SEARCH NODE
Use this for fast keyword-based search as a Code node in your workflow.

**Location:** `n8n-quick-search-node.js`
...
## 2. COMPREHENSIVE SEARCH TOOL (For Agent)
Use this as a Code node tool connected to your Agent's tools.

**Location:** `n8n-comprehensive-search-tool-fixed.js`
...
### Quick Search (Workflow Node):
1. Add a **Code** node after your Context node
2. Name it "Quick Search"
3. Paste the Quick Search code
4. Connect to your vector store or next processing node

### Comprehensive Search (Agent Tool):
1. Add a **Code** node to your Agent's tools
2. Name it "Comprehensive Search"
3. Description: "Search internal knowledge base for relevant documents"
4. Paste the Comprehensive Search code
5. The tool returns a string (HTML) directly

## Key Differences:

**Quick Search:**
- Returns JSON object with search parameters
- For use in workflow processing
- Fast keyword extraction
- Outputs to next nodes

**Comprehensive Search:**
- Returns HTML string directly
- For use as Agent tool
- Deep semantic analysis
- Self-contained response

Both are ready to use in your n8n workflow!